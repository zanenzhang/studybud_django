...
#Do not use login, reserved function in Django
...
def home(request):
    ...
    #the i in icontains is for case insensitive, | for or, & for and
...
def userProfile(request, pk):
    ...
    #can get children of an object by using object_set
